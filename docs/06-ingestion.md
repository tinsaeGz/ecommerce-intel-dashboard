...
- Visual implementation of field-role dropdowns follows the shared selection component and interaction contract in [UI/UX Concept §12.13](../UI-UX-CONCEPT.md#1213-dropdowns-and-selection-surfaces). This older ingestion design remains subordinate to `SDLC.md` v4; styling does not authorize its older fixed-schema API behavior.
